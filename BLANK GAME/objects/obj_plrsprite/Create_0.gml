...
back_skin = noone
back_decal = instance_create_layer(x, y, "Instances", obj_plrdecal)
...
mouth_decal = instance_create_layer(x, y, "Instances", obj_plrdecal)
mouth_decal.host = self
mouth_decal.type = "mouth"

eyes_skin = real(spr_plreyes_default)
eyes_decal = instance_create_layer(x, y, "Instances", obj_plrdecal)
eyes_decal.host = self
eyes_decal.type = "eyes"

hat_skin = noone
hat_decal = instance_create_layer(x, y, "Instances", obj_plrdecal)
hat_decal.host = self
hat_decal.type = "hat"
