stat_hp = struct_get(obj_eng_dictionary.plrdefaultstats, "hpstat")
stat_lives = struct_get(obj_eng_dictionary.plrdefaultstats, "livesstat")
stat_size = struct_get(obj_eng_dictionary.plrdefaultstats, "sizestat")
stat_speed = struct_get(obj_eng_dictionary.plrdefaultstats, "speedstat")
stat_strength = struct_get(obj_eng_dictionary.plrdefaultstats, "strengthstat")
stat_attackspeed = struct_get(obj_eng_dictionary.plrdefaultstats, "attackspeedstat")
stat_shotspeed = struct_get(obj_eng_dictionary.plrdefaultstats, "shotspeedstat")
stat_shotsize = struct_get(obj_eng_dictionary.plrdefaultstats, "shotsizestat")
stat_range = struct_get(obj_eng_dictionary.plrdefaultstats, "rangestat")
...
{
	var itemstat = struct_get(obj_eng_dictionary.itemstruct, string(items[a]))
